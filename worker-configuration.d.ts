/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bd1f0e1b8042c220df308e44da94c696)
// Runtime types generated with workerd@1.20260903.1 2026-09-04 nodejs_als
interface __BaseEnv_Env {
	DB: D1Database;
	PAD_UNLOCK_RATE_LIMITER: RateLimit;
	CLIENT_UNLOCK_RATE_LIMITER: RateLimit;
	CLIENT_CREATE_RATE_LIMITER: RateLimit;
	GLOBAL_CREATE_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SIGNING_KEY">> {}
}
